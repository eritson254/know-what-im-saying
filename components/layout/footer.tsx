...
export function Footer() {
  return (
    <footer className="bg-accent px-6 py-12 text-accent-foreground md:px-16 md:py-[60px] md:pb-[46px]">
      ...
      <div className="mx-auto mt-10 flex max-w-[1240px] flex-col gap-2 border-t border-white/12 pt-6 font-mono text-[10px] tracking-[.08em] text-[#9fb09a] uppercase md:flex-row md:justify-between">
